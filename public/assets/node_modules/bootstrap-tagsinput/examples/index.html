...
<body>
  ...
  <div class="jumbotron">
    <div class="container">
      ...
      <p>
        <a class="btn btn-default" role="button" href="https://github.com/bootstrap-tagsinput/bootstrap-tagsinput">Code
          on Github</a>
        <a class="btn btn-default" role="button" href="bootstrap-2.3.2.html">Bootstrap 2.3.2</a>
        <a class="btn btn-primary" role="button"
          href="https://codeload.github.com/bootstrap-tagsinput/bootstrap-tagsinput/zip/latest">Download</a>
      </p>
      <p>
      <ul class="list-inline">
        <li>
          <iframe
            src="//ghbtns.com/github-btn.html?user=bootstrap-tagsinput&repo=bootstrap-tagsinput&type=watch&count=true"
            allowtransparency="true" frameborder="0" scrolling="0" width="110" height="20"></iframe>
        </li>
        <li>
          <iframe
            src="//ghbtns.com/github-btn.html?user=bootstrap-tagsinput&repo=bootstrap-tagsinput&type=fork&count=true"
            allowtransparency="true" frameborder="0" scrolling="0" width="110" height="20"></iframe>
        </li>
        <li>
  ...
  <div class="container">
    <section id="examples">
      ...
      <div class="example example_markup">
        <h3>Markup</h3>
        <p>Just add <code>data-role="tagsinput"</code> to your input field to automatically change it to a tags input
          field.</p>
      ...
      <div class="example example_multivalue">
        ...
        <p>
          Use a <code>&lt;select multiple /&gt;</code> as your input element for a tags input, to gain true multivalue
          support. Instead of a comma separated string, the values will be set in an array. Existing
          <code>&lt;option /&gt;</code> elements will automatically be set as tags. This makes it also possible to
          create tags containing a comma.
        </p>
        <div class="bs-example">
...
&lt;/select&gt;</code></pre>
      ...
      <div class="example example_typeahead">
        <h3>Typeahead</h3>
        Typeahead is not included in Bootstrap 3, so you'll have to include your own typeahead library. I'd recommed <a
          href="http://twitter.github.io/typeahead.js/">typeahead.js</a>. An example of using this is shown below.
...
&lt;/script&gt;</code></pre>
      ...
      <div class="example example_objects_as_tags">
        ...
        <p>
          Instead of just adding strings as tags, bind objects to your tags. This makes it possible to set id values in
          your input field's value, instead of just the tag's text.
        </p>
        <div class="bs-example">
          <input type="text" />
        </div>
...
&lt;/script&gt;</code></pre>
  ...
  tagClass: function(item) {
    return (item.length > 10 ? 'big' : 'small');
            ...
            <tr>
              ...
              <td>
                <p>When adding objects as tags, itemValue <em>must</em> be set to the name of the property containing
                  the item's value, or a function returning an item's value.</p>
                <pre><code data-language="javascript">$('input').tagsinput({
    itemValue: 'id'
});</code></pre>
                <pre><code data-language="javascript">$('input').tagsinput({
  itemValue: function(item) {
    return item.id;
            ...
            <tr>
              ...
              <td>
                <p>When adding objects as tags, you can set itemText to the name of the property of item to use for a
                  its tag's text. You may also provide a function which returns an item's value. When this options is
                  not set, the value of <code>itemValue</code> will be used.
  ...
  itemText: function(item) {
    return item.label;
            ...
            <tr>
              ...
              <td>
                <p>Array of keycodes which will add a tag when typing in the input. (default: [13, 188], which are ENTER
                  and comma)</p>
                <pre><code data-language="javascript">$('input').tagsinput({
  confirmKeys: [13, 44]
});</code></pre>
            ...
            <tr>
              ...
              <td>
                <p>When set, no more than the given number of tags are allowed to add (default: undefined). When maxTags
                  is reached, a class 'bootstrap-tagsinput-max' is placed on the tagsinput element.</p>
                <pre><code data-language="javascript">$('input').tagsinput({
  maxTags: 3
});</code></pre>
              </td>
            ...
            <tr>
              ...
              <td>
                ...
                <div class="bs-callout bs-callout-warning">
                  This is only possible when using string as tags. When itemValue option is set, this option will be
                  ignored.
                </div>
                <pre><code data-language="javascript">$('input').tagsinput({
  typeahead: {
  ...
  freeInput: true
            ...
            <tr>
              ...
              <td>
                <p>Object containing typeahead specific options
              </td>
            </tr>
            </tr>
            <tr>
  ...
  typeahead: {
    source: function(query) {
      return $.get('http://someservice.com');
            ...
            <tr>
              <td colspan="2"><code>cancelConfirmKeysOnEmpty</code></td>
              <td>
                <p>Boolean value controlling whether form submissions get processed when pressing enter in a field
  ...
  cancelConfirmKeysOnEmpty: true
            ...
            <tr>
              ...
              <td>
                <p>Function invoked when trying to add an item which allready exists. By default, the existing tag hides
                  and fades in.
                <pre><code data-language="javascript">$('input').tagsinput({
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                Optionally, you can pass a 3rd parameter (object or value) to the <code>add</code> method to gain more
                control over the process. The parameter is exposed in the <code>options</code> attribute of the event.
         ...
         if (response.failure) {
            ...
            <tr>
              ...
              <td>
                ...
                Optionally, you can pass a 3rd parameter (object or value) to the <code>remove</code> method to gain
                more control over the process. The parameter is exposed in the <code>options</code> attribute of the
                event.
...
$('#tags-input').on('beforeItemRemove', function(event) {
   ...
   if (!event.options || !event.options.preventPost) {
      $.ajax('/ajax-url', ajaxData, function(response) {
         if (response.failure) {
            ...
            <tr>
              ...
              <td>
                <p>Returns the tagsinput's internal &lt;input /&gt;, which is used for adding tags. You could use this
                  to add your own typeahead behaviour for example.</p>
            ...
            <tr>
              ...
              <td>
                <p>Refreshes the tags input UI. This might be usefull when you're adding objects as tags. When an
                  object's text changes, you'll have to refresh to update the matching tag's text.</p>
      ...
      <section id="methods">
        ...
        <table class="table table-bordered table-condensed">
          ...
          <tbody>
            <tr>
              <td><code>itemAddedOnInit</code></td>
              <td>
                During initialization, pre-defined tags being added will cause this event to be triggered. Example:
                <pre><code data-language="javascript">$('input').on('itemAddedOnInit', function(event) {
  ...
  <footer class="footer">
    <div class="container">
      <p>Code licensed under <a href="https://raw.github.com/TimSchlechter/bootstrap-tagsinput/master/LICENSE"
