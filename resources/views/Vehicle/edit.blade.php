...
@section('container')
    <div class="card">
        <div class="card-body p-0">
            <form action="/vehicle/{{ $vehicles->nomor_bpkb }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="nomor_bpkb" id="nomor_bpkb" type="text" class="form-control" value="{{ old('nomor_bpkb', $vehicles->nomor_bpkb) }}" required autofocus>
                                    ...
                                    <input name="tanggal_jatuh_tempo" id="tanggal_jatuh_tempo" type="date" class="form-control" value="{{ old('tanggal_jatuh_tempo', $vehicles->tanggal_jatuh_tempo) }}" required autofocus>
                                    
                                    <label class="mt-2" for="bulan_jatuh_tempo">Bulan Jatuh Tempo</label>
                                    <input name="bulan_jatuh_tempo" id="bulan_jatuh_tempo" type="text" class="form-control" value="{{ old('bulan_jatuh_tempo', $vehicles->bulan_jatuh_tempo) }}" required autofocus>
                                    
                                    <label class="mt-2" for="bagian_lokasi">Divisi/Lokasi</label>
                                    <input name="bagian_lokasi" id="bagian_lokasi" type="text" class="form-control" value="{{ old('bagian_lokasi', $vehicles->bagian_lokasi) }}" required autofocus>
                                </div>
                            </div>
                        </div>
                    </div>
