...
class EmployeeController extends Controller
{
    ...
    public function store(StoreEmployeeRequest $request)
    {
        $validationData = $request->validate([
            ...
            'nomor_bpjsket' => 'required',
            'tanggal_masuk_bpjsket' => 'required',
            'tanggal_keluar_bpjsket' => 'required',
            'nomor_bpjskes' => 'required',
            'tanggal_masuk_bpjskes' => 'required',
            'tanggal_keluar_bpjskes' => 'required',
            // riwayat
